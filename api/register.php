...
try {
    ...
    try {
        $mail = new PHPMailer();
        $mail->SMTPDebug = SMTP::DEBUG_OFF; // Désactiver le débogage par défaut
    ...
    jsonResponse(['status' => 'error', 'message' => 'Une erreur est survenue lors de l\'inscription. Veuillez réessayer.'], 500);
}
